...
class ScopedCredential(TokenCredential):
    """Custom credential wrapper that ensures tokens are requested with the correct scope"""
    ...
    def get_token(self, *scopes, **kwargs) -> AccessToken:
        """Override get_token to always use the specified scope"""
        print(f"Requesting token with scope: {self._scope}")
...
try:
#     # Use AzureCliCredential wrapped with the correct scope for Cognitive Services
#     base_credential = AzureCliCredential()

#     # Wrap the credential to ensure it always requests tokens with the Cognitive Services scope
...
#         print("Successfully obtained token with Cognitive Services scope")
#         print(f"Token expires on: {token.expires_on}")
#     except Exception as token_error:
#         print(f"Warning: Could not pre-fetch token: {token_error}")
